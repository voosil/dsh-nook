...
import { retainCandidateNode } from './update-worktree.mjs'
...
const node = await retainCandidateNode(directory)
const snapshot = { seedProfile: packed.profile, node, supervisor: join(boot, 'supervisor.mjs') }
